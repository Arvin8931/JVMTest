...
public class Client {
    ...
    public void haveAuthManager() {
        ...
        InfoManager authManager = InfoManagerFactory.getAuthInstance(new AuthProxy("test"));
        doCRUD(authManager);
        separatorLine();
    }
    ...
    public void selectivityAuthManager() {
        ...
        InfoManager authManager = InfoManagerFactory.getSelectivityAuthInstance(new AuthProxy("test1"));
        doCRUD(authManager);
        separatorLine();
    }
